    ...
    <Card className={classes.root} onClick={handlePostClick}>
      <CardHeader
        ...
        subheader={
          <div className={classes.subheader}>
            ...
            <Typography variant="subtitle2" className={classes.caption} >{props.author.name}</Typography>
            <Typography variant="subtitle2" className={classes.caption} >{moment(props.date).fromNow()}</Typography>
          </div>
        }
      />
      <CardContent className={classes.content} >
      <Typography className={classes.message} variant="body1">{`${props.tags}`}</Typography>
      </CardContent>
      <CardActionArea>
      ...
      <CardActions disableSpacing>
        ...
        <IconButton aria-label="comment">
          <MessageIcon />
          <Typography className={classes.reaction} color="textSecondary" variant="body2">{'30'}</Typography>
        </IconButton>
